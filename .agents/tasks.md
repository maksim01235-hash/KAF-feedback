...
- [ ] `TASK-20260901-34` — История навигации: «назад» возвращает на предыдущий маршрут (`pending`)
- [ ] `TASK-20260901-35` — «Имя», «Отзыв», «Вопрос» по левому краю, шрифт как на кнопках (`pending`)
- [ ] `TASK-20260901-36` — Hydration error: отключить SSR для AppRouter (`pending`)
- [ ] `TASK-20260901-37` — Отображение вопросов на странице площадки (`pending`, после 36)
- [ ] `TASK-20260901-38` — Оптимизация долгой загрузки площадки (кэш + фоновое обновление) (`pending`, после 37)
