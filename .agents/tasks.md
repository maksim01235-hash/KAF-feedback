...
- [ ] `TASK-20260901-01` — Скаффолд Next.js-проекта и общая база (`needs-review`)
- [ ] `TASK-20260901-02` — Логика времени и активности площадок (`ready`, parallel после 01)
- [ ] `TASK-20260901-03` — Логика валидации форм (`ready`, parallel после 01)
- [ ] `TASK-20260901-04` — Логика кэширования расписания (`ready`, parallel после 01)
- [ ] `TASK-20260901-05` — Логика идентификации и прав (`ready`, parallel после 01)
- [ ] `TASK-20260901-06` — Бэкенд Google Apps Script (`ready`, parallel после 01)
- [ ] `TASK-20260901-07` — Фронтенд: страницы, компоненты, хэш-роутинг, состояния (после 02–05)
- [ ] `TASK-20260901-08` — README и финальная интеграция (после 06–07)
