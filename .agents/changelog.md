...
Все задачи TASK-20260901-01 … 08 выполнены и запушены. Дополнительно: исправлен баг хэш-роутинга (переход на SPA на одной странице) и дополнена документация по таблице и `appsscript.json`.
